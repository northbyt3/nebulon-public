...
const baseUrl = getArg("--base-url", process.env.BASE_URL || "http://localhost:3333");
const keypairPath = getArg(
  "--keypair",
  process.env.ANCHOR_WALLET || path.join(process.env.HOME || process.env.USERPROFILE || ".", ".config", "solana", "id.json")
);
